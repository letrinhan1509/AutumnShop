...
const Shoes = (props) => {
  ...
  const giay = props.ListProductHome.filter(ListProductHome => ListProductHome.maloai === "giay");
  let Giay = [];
  Giay = giay;
      ...
      <Row className="content-box">
        ...
        <Col className="right">
          <Carousel dots="" autoplay className="carousel">
            <div>
              <img src="../images/slider/slider_giay1.jpeg" alt="slider" />
            </div>
            <div>
              <img src="../images/slider/slider_giay2.jpeg" alt="slider" />
            </div>
            <div>
              <img src="../images/slider/slider_giay3.png" alt="slider" />
            </div>
          </Carousel>
          <div className="site-card-wrapper product_home">
            <Row>
              {Giay.slice(0, visible).map((productItem) => {
                return (
